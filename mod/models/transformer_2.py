# -*- coding: utf-8 -*-
"""
Created on 2021/9/7 下午6:23

@Project -> File: srv-pollution-grid-forecast-control-offline-training -> transformer_2.py
...
class Decoder(nn.Module):
    ...
    def forward(self, dec_inputs, enc_inputs, enc_outputs):
        ...
        # Decoder中不仅要把"pad"mask掉，还要mask未来时刻的信息，因此就有了下面这三行代码，
        # 其中torch.gt(a, value)的意思是，将a中各个位置上的元素和value比较，若大于value，则该位置取1，否则取0
...
if __name__ == '__main__':
    sentences = [
        ...
        ['ich mochte zehr ein cola', 'S i want a coke .', 'i want a coke . E']
    ]
